...
<html lang="en">
    <head>
        ...
        <!-- start: Meta -->
        <meta charset="utf-8">
        <title>Collins Admin Panel Dashboard</title>
        <meta name="description" content="Collins Admin Panel Dashboard">
        <meta name="author" content="Engr Rostom Ali">
        <meta name="keyword" content="Collins Admin Panel Dashboard">
        <!-- end: Meta -->

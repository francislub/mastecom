...
<html lang="en">
    <head>
        ...
        <!-- start: Meta -->
        <meta charset="utf-8">
        <title>Collins Login Panel</title>
        ...
        <style type="text/css">
            body { background: url(<?php echo base_url()?>assets/admin/img/3.webp) !important; }
        </style>
            ...
            <div class="row-fluid">
                ...
                <div class="row-fluid">
                    <div class="login-box">
                        ...
                        <div class="button-login">
                            <button class="login"><a href="<?php echo base_url('/customer/login'); ?>">Login</a>
                            </button>
                        </div>
